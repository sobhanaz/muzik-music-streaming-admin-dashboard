<template>
  <li v-if="isTag !== 'router-link'" :class="navItemClass">
    <a ref="elem" :class="navLinkClass" aria-current="page" :href="createRoute(route.to)" :to="route" :aria-expanded="collapseActive" @click.prevent="onClickNav">
      ...
      <i v-if="miniTitle !== '' && miniTitle !== null" v-b-tooltip.hover.right="title" class="sidenav-mini-icon" :title="title"> {{ miniTitle }} </i>
