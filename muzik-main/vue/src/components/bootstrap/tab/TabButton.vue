<template>
  <component :is="tag" :id="idName" ref="bsTab" :class="classNames" :data-bs-toggle="toggleType" :data-bs-target="target" role="tab" :aria-controls="target" :aria-selected="active">
    <slot></slot>
  </component>
</template>
<script>
