  ...
  <b-row>
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <h3 class="mt-2">Example heading<span class="badge bg-success ms-1">New</span></h3>
      ...
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <div class="mt-2 d-flex gap-1 flex-wrap">
            <button type="button" class="btn mb-1 btn-primary">Notifications <span class="badge bg-light text-dark ms-1">4</span></button>
            <button type="button" class="btn mb-1 btn-success">Notifications <span class="badge bg-light text-dark ms-1">4</span></button>
            <button type="button" class="btn mb-1 btn-danger">Notifications <span class="badge bg-light text-dark ms-1">4</span></button>
          </div>
        </b-card-body>
      </b-card>
      ...
      <b-card no-body>
        ...
        <b-card-body>
          <p>Badges can be used as part of buttons to provide a counter.</p>
          <div class="mt-2 d-flex gap-1 flex-wrap">
            <button type="button" class="btn mb-1 btn-outline-primary">Notifications <span class="badge bg-primary ms-1">4</span></button>
            <button type="button" class="btn mb-1 btn-outline-success">Notifications <span class="badge bg-success ms-1">4</span></button>
            <button type="button" class="btn mb-1 btn-outline-danger">Notifications <span class="badge bg-danger ms-1">4</span></button>
          </div>
        </b-card-body>
      </b-card>
      <b-card no-body>
        ...
        <b-card-body>
          <p>Badges can be used as part of buttons to provide a counter.</p>
          <div class="mt-2 d-flex gap-1 flex-wrap">
            <button type="button" class="btn mb-1 bg-soft-primary">Notifications <span class="badge bg-primary ms-1">4</span></button>
            <button type="button" class="btn mb-1 bg-soft-success">Notifications <span class="badge bg-success ms-1">4</span></button>
            <button type="button" class="btn mb-1 bg-soft-danger">Notifications <span class="badge bg-danger ms-1">4</span></button>
          </div>
        </b-card-body>
      </b-card>
    </b-col>
    ...
    <b-col sm="12" lg="6">
      ...
      <b-card no-body>
        ...
        <b-card-body>
          <div class="mt-2 d-flex flex-wrap gap-1">
            <span class="mt-1 badge border border-primary text-primary mt-1">Primary</span>
            <span class="mt-2 badge border border-secondary text-secondary mt-1">Secondary</span>
            <span class="mt-1 badge border border-success text-success mt-1">Success</span>
            <span class="mt-1 badge border border-danger text-danger mt-1">Danger</span>
            <span class="mt-1 badge border border-warning text-warning mt-1">Warning</span>
            <span class="mt-1 badge border border-info text-info mt-1">Info</span>
            <span class="mt-1 badge border border-light text-light mt-1">Light</span>
            <span class="mt-1 badge border border-dark text-dark mt-1">Dark</span>
            <span class="mt-1 badge border border-gray text-gray mt-1">Gray</span>
            <div>
              <h5 class="card-title mt-4">Pill badges</h5>
              <p class="mb-2">Use the <code>.badge-pill</code> modifier class to make badges more rounded (with a larger <code>border-radius</code> and additional horizontal <code>padding</code>). Useful if you miss the badges from v3.</p>
              <div class="mt-2 d-flex flex-wrap gap-1">
