        ...
        <b-card-body>
          <div class="mt-2 d-flex flex-wrap gap-2">
            ...
            <button type="button" class="btn btn-danger mt-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-video" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="d-inline-block w-100">
              ...
              <button type="button" class="btn btn-secondary mt-2">
                <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  <path d="M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" />
                </svg>
                >Buttons
              ...
              <button type="button" class="btn btn-info mt-2">
                <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  <line x1="4" y1="7" x2="20" y2="7" />
                  <line x1="10" y1="11" x2="10" y2="17" />
                  <line x1="14" y1="11" x2="14" y2="17" />
      ...
      <b-card no-body>
        ...
        <b-card-body>
          <div class="mt-2 d-flex flex-wrap gap-2">
            ...
            <button type="button" class="btn btn-accent disabled mt-2" :disabled="true">Disabled</button>
            <button type="button" class="btn btn-primary disabled mt-2" :disabled="true">Disabled</button>
            <button type="button" class="btn btn-outline-primary disabled mt-2" :disabled="true">Disabled</button>
          </div>
        </b-card-body>
      </b-card>
    </b-col>
          ...
          <div class="mt-2">
            ...
            <div class="btn-group btn-group-medium" role="group" aria-label="Button group with nested dropdown">
              ...
              <div class="btn-group btn-group-medium" role="group">
                <button id="btnGroupDrop1" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
            ...
            <div class="d-block mt-2">
              <div class="btn-group-vertical" role="group" aria-label="Button group with nested dropdown">
                ...
                <div class="btn-group" role="group">
                  <button id="btnGroupDrop2" type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
