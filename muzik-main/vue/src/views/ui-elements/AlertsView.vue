  ...
  <b-row>
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <b-alert show dismissible variant="success mb-3"> This is a success alert—check it out! </b-alert>
          <b-alert show dismissible variant="info mb-3"> This is a info alert—check it out! </b-alert>
          <b-alert show dismissible variant="warning mb-3"> This is a warning alert—check it out! </b-alert>
          <b-alert show dismissible variant="danger mb-3"> This is a danger alert—check it out! </b-alert>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col sm="12" lg="6">
    ...
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <b-alert show dismissible variant="success  mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="info alert-solid mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="warning mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="danger mb-3"> This is a danger alert—check it out! </b-alert>
        </b-card-body>
      </b-card>
    </b-col>
    ...
    <b-col sm="12">
      <b-card no-body>
        ...
        <b-card-body>
          <b-alert show dismissible variant="success alert-left mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="info alert-top mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="warning alert-right mb-3"> This is a danger alert—check it out! </b-alert>
          <b-alert show dismissible variant="danger alert-bottom mb-3"> This is a danger alert—check it out! </b-alert>
        </b-card-body>
      </b-card>
    </b-col>
    <b-col sm="12">
