      ...
      <b-card no-body>
        ...
        <b-card-body>
          <b-form>
            <b-form-group>
              <label for="input-201" class="form-label">Small</label>
              <b-form-select id="input-201" :options="options01" size="sm"></b-form-select>
            </b-form-group>
            <b-form-group>
              <label for="input-202" class="form-label">Default</label>
              <b-form-select id="input-202" :options="options01"></b-form-select>
            </b-form-group>
            <b-form-group>
              <label for="input-203" class="form-label">Large</label>
              <b-form-select id="input-203" :options="options01" size="lg"></b-form-select>
            </b-form-group>
          </b-form>
        </b-card-body>
      </b-card>
          ...
          <b-form>
            <b-form-group>
              <b-row class="align-items-center">
                ...
                <b-col sm="9">
                  <b-form-input id="input-1101" placeholder="Enter Your Email"></b-form-input>
                </b-col>
              </b-row>
            </b-form-group>
            <b-form-group>
              <b-row class="align-items-center">
                ...
                <b-col sm="9">
                  <b-form-input id="input-1102" type="password" placeholder="Enter Your Password"></b-form-input>
                </b-col>
              </b-row>
            </b-form-group>
            <b-form-group>
            ...
            <b-form>
              <b-form-group>
                <b-row class="align-items-center">
                  ...
                  <b-col sm="9">
                    <b-form-input id="input-2201" placeholder="Enter Your Email"></b-form-input>
                  </b-col>
                </b-row>
              </b-form-group>
              <b-form-group>
                <b-row class="align-items-center">
                  ...
                  <b-col sm="9">
                    <b-form-input id="input-2202" type="password" placeholder="Enter Your Password"></b-form-input>
                  </b-col>
                </b-row>
              </b-form-group>
              <b-form-group>
        ...
        <b-card-body>
          <b-form>
            <b-form-group>
              ...
              <b-form-input id="input-1301" readonly disabled placeholder="John Carter"></b-form-input>
            </b-form-group>
            <b-form-group>
            ...
            <b-form-group>
              ...
              <b-form-select id="input-1303" :options="ageOptions"></b-form-select>
            </b-form-group>
            <b-form-group>
              <label for="input-1304" class="form-label">Select Input New</label>
              <b-form-select id="input-1304" :options="ageOptions"></b-form-select>
            </b-form-group>
            <b-form-group>
              <label for="input-1305" class="form-label">Default</label>
              <b-form-select id="input-1305" :options="options01" :select-size="4"></b-form-select>
            </b-form-group>
            <b-form-group>
            ...
            <b-form-group>
              ...
              <b-form-input id="input-1307" type="range4"></b-form-input>
            </b-form-group>
            <b-form-group>
              <b-form-checkbox>Default Checkbox</b-form-checkbox>
              <b-form-checkbox v-model="checked" value="true">Checked Checkbox</b-form-checkbox>
              <b-form-checkbox disabled>Default Checkbox</b-form-checkbox>
              <b-form-checkbox v-model="checked" disabled value="true">Checked Checkbox</b-form-checkbox>
            </b-form-group>
            <b-form-group>
              <b-form-radio>Default Radio</b-form-radio>
              <b-form-radio v-model="checked" value="true">Checked Radio</b-form-radio>
              <b-form-radio disabled>Default Radio</b-form-radio>
              <b-form-radio v-model="checked" disabled value="true">Checked Radio</b-form-radio>
            </b-form-group>
            <b-form-group>
