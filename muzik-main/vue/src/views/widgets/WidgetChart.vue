    ...
    <b-col lg="3">
      <b-card no-body>
        <b-card-body>
          ...
          <div class="text-center">
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="966" />K</h2>
            <div>
              <span>
                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M5.293 7.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L6.707 7.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
    ...
    <b-col lg="3">
      <b-card no-body>
        <b-card-body>
          ...
          <div class="text-center">
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="155" />K</h2>
            <div>
  ...
  <b-row>
    <b-col lg="3">
      <b-card>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h6>
            <b>$<Vue3autocounter ref="counter" :start-amount="0" :end-amount="18378" /></b>
          </h6>
    ...
    <b-col lg="3">
      <b-card>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h6>
            <b>$<Vue3autocounter ref="counter" :start-amount="0" :end-amount="190" /></b>
          </h6>
    ...
    <b-col lg="3">
      <b-card>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h6>
            <b><Vue3autocounter ref="counter" :start-amount="0" :end-amount="45" /></b>
          </h6>
    ...
    <b-col lg="3">
      <b-card>
        ...
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <h6>
              <b><Vue3autocounter ref="counter" :start-amount="0" :end-amount="60" /></b>
            </h6>
          </div>
      ...
      <b-card>
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-center">
            ...
            <h2><Vue3autocounter ref="counter" :start-amount="0" :end-amount="352" /></h2>
          </div>
          <div class="pt-3">
